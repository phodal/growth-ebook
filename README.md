...
*   [前端与后台](http://growth.phodal.com/#前端与后台)
    ...
    *   [消息队列](http://growth.phodal.com/#消息队列)
...
*   [回顾与架构设计](http://growth.phodal.com/#回顾与架构设计)
    *   [自我总结](http://growth.phodal.com/#自我总结)
        *   [为什么你不看不到自己的方向？](http://growth.phodal.com/#为什么你不看不到自己的方向)
...
*   [基础实战篇](http://growth.phodal.com/#基础实战篇)
    *   [Django](http://growth.phodal.com/#django)
        *   [架构](http://growth.phodal.com/#架构)
    *   [创建Django项目](http://growth.phodal.com/#创建django项目)
    *   [Mezzanine](http://growth.phodal.com/#mezzanine)
